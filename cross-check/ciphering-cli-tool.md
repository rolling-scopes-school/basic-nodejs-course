...
* Использование любых сторонних пакетов, библиотек, фреймворков (за исключением инструментов для улучшения качества кода или процесса разработки, таких как `nodemon`, `prettier`, `eslint` и его плагины) **минус 150 баллов**
